 ...
 * ProjectSkillR entities. Transaction control of the save(), update() and
...
public class ProjectSkillRDAO extends BaseHibernateDAO {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding ProjectSkillR instance with property: "
	...
	public ProjectSkillR merge(ProjectSkillR detachedInstance) {
		...
		try {
			ProjectSkillR result = (ProjectSkillR) getSession().merge(
					detachedInstance);
