...
/**
 	* A data access object (DAO) providing persistence and search support for GroupStudentR entities.
...
public class GroupStudentRDAO extends BaseHibernateDAO  {
    ...
    public GroupStudentR findById( java.lang.Integer id) {
        ...
        try {
            GroupStudentR instance = (GroupStudentR) getSession()
                    .get("com.group.model.GroupStudentR", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding GroupStudentR instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public GroupStudentR merge(GroupStudentR detachedInstance) {
        ...
        try {
            GroupStudentR result = (GroupStudentR) getSession()
