...
/**
 	* A data access object (DAO) providing persistence and search support for Professor entities.
...
public class ProfessorDAO extends BaseHibernateDAO  {
    ...
    public Professor findById( java.lang.Integer id) {
        ...
        try {
            Professor instance = (Professor) getSession()
                    .get("com.group.model.Professor", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Professor merge(Professor detachedInstance) {
        ...
        try {
            Professor result = (Professor) getSession()
