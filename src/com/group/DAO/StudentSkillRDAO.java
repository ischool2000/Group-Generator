...
/**
 	* A data access object (DAO) providing persistence and search support for StudentSkillR entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.group.model.StudentSkillR
...
public class StudentSkillRDAO extends BaseHibernateDAO  {
    ...
    public StudentSkillR findById( java.lang.Integer id) {
        ...
        try {
            StudentSkillR instance = (StudentSkillR) getSession()
                    .get("com.group.model.StudentSkillR", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(StudentSkillR instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.group.model.StudentSkillR")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding StudentSkillR instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public StudentSkillR merge(StudentSkillR detachedInstance) {
        ...
        try {
            StudentSkillR result = (StudentSkillR) getSession()
