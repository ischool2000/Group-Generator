...
/**
 	* A data access object (DAO) providing persistence and search support for ClassStudentR entities.
...
public class ClassStudentRDAO extends BaseHibernateDAO  {
    ...
    public ClassStudentR findById( java.lang.Integer id) {
        ...
        try {
            ClassStudentR instance = (ClassStudentR) getSession()
                    .get("com.group.model.ClassStudentR", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding ClassStudentR instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public ClassStudentR merge(ClassStudentR detachedInstance) {
        ...
        try {
            ClassStudentR result = (ClassStudentR) getSession()
